...
function $StateProvider(   $urlRouterProvider,   $urlMatcherFactory) {
   ...
   */
  this.$get = $get;
  $get.$inject = ['$rootScope', '$q', '$view', '$injector', '$resolve', '$stateParams', '$urlRouter', '$viewPreventUpdate'];
  function $get(   $rootScope,   $q,   $view,   $injector,   $resolve,   $stateParams,   $urlRouter, $viewPreventUpdateProvider) {
